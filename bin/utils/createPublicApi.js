...
const createPublicApi = async ({slicePath, sliceName, withModel, useModelDirectories, typescript}) => {
...
${withModel ? `export type { ${componentName}Schema } from './model/${useModelDirectories ? 'types/' : ''}${firstLetterToLowerCase(sliceName)}Schema';`: ''}
`
    )
  } catch(e) {
